...
export const defaultTeamCarouselConfig: HeroConfig = {
  slides: [
    ...
    { image: getAssetUrl('media/home_slides/home_2026_1.jpg'), alt: "RCV Lab Group Photo 2026_1" },
    { image: getAssetUrl('media/home_slides/home_2026_2.jpg'), alt: "RCV Lab Group Photo 2026_2" },
    { image: getAssetUrl('media/home_slides/home_2026_3.jpg'), alt: "RCV Lab Group Photo 2026_3" },
    { image: getAssetUrl('media/home_slides/home_2026_4.jpg'), alt: "RCV Lab Group Photo 2026_4" },
  ],
  autoPlay: true,
  slideDuration: 4000,
  showNavigation: true,
